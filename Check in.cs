...
namespace HOTEL
{
    public partial class Check_in : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string nombre, telefono, edad, Habitacion,entrada,salida;
            int dias;
            entrada = dataEntrada.Text;
            salida = dataSalida.Text;
            nombre = txtNombre.Text;
      ...
      string consulta = "INSERT INTO hotel values(null,'" + txtNombre.Text + "','" + txtTelefono.Text + "','" + txtEdad.Text + "','" + txtDias.Text + "','" + Habitacion + "','" + txtTotal.Text+ "','" + dataEntrada.Text + "','" + dataSalida.Text + "');";
